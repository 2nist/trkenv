...
export default function TimelineFooter({ zoom, setZoom, itemHeight, setItemHeight }: FooterProps) {
  ...
  return (
    <footer className="timeline-footer px-4" style={{backgroundColor: '#ffffff', color: '#000000'}}>
        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col text-xs">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-[11px] mt-1" style={{color: '#000000'}}>{zoom}px / beat</div>
            </div>
          </div>
          ...
          <div className="flex flex-col text-xs">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-[11px] mt-1" style={{color: '#000000'}}>{itemHeight}px</div>
            </div>
          </div>
        </div>

        <div className="text-sm" style={{color: '#000000'}}>Vintage controls</div>
      </div>
    </footer>
  )
}
